...
s16a_mra tetris    "Tetris" "Rotate,Rotate,Rotate" "ff,ff" "Puzzle" "Puzzle/Drop" "Sega S16A"
s16a_mra aliensyn  "Alien Syndrome" "Shot,-,-" "ff,ff" "Run & Gun" "Maze/Shooter Large" "Sega S16A"
s16a_mra bodyslam  "Body Slam" "Punch/Throw/Attack,Kick/Tag/Pin,-" "ff,ff" "Sports" "Sports/Wrestling" "Sega S16A"
